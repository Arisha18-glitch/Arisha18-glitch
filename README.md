...
Task Manager System	Dynamic task manager with queue, reminders, and AI chatbot assistant	C++, HTML, JS, Python	View Repo

AI Network Detection	Rule-based AI for network anomaly detection	Python, Flask, MongoDB	View Repo

BookSphere	Social media platform connecting book lovers	Python, Firebase	View Repo

Smart City Management	Academic project for city services management	UML, Python, Firebase	View Repo
